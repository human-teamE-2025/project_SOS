...
<aside id="left-nav" style="display: block;">
    <ul id="nav-item">
        <button id="btn-home"><i class="fa-solid fa-house">홈</i></button>
        ...
        <button id="btn-thumup"><i class="fa-solid fa-thumbs-up"></i>좋아요 표시한 음악</button>
        <hr>
        <button id="btn-artist"><i class="fa-solid fa-music"></i>구독한 아티스트</button>
        <button id="btn-artist"><i class="fa-solid fa-music"></i>구독한 아티스트</button>
        <button id="btn-artist"><i class="fa-solid fa-music"></i>구독한 아티스트</button>
        <button id="btn-artist"><i class="fa-solid fa-music"></i>구독한 아티스트</button>
        <button id="btn-artist"><i class="fa-solid fa-music"></i>구독한 아티스트</button>
